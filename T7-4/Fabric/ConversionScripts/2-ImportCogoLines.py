...
#
# Currently setup to work on: OutGDB = "C:/Taxmap/T7-4/fabric/OrMapPFTemplate.gdb"
#   "PLSSLines","ReferenceLines","TaxlotsFD/TaxlotLines"
# Dependencies
#   OutGDB = "C:/Taxmap/T7-4/fabric/OrMapPFTemplate.gdb"
#   InGDB ="C:/Taxmap/T7-4/geodb/townedgeo.gdb"
#   WorkGdb = Default gdb for temp feature class to be stored 
# 
# Dean 9/7/2020
# 
#-------------------------------------------------------------------------------
...
# For each feature class do conversion - must distinguish between
# those class that are in the TaxlotsFD dataset and those that are not 
